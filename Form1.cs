    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("alumnos.csv not found in Documents/Feedback-Flow or App Directory.", "Missing CSV", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private async void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please select a Class Content PDF first.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            MessageBox.Show($"Process Completed.\nSuccess: {successCount}\nErrors: {errorCount}", "Finished", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
